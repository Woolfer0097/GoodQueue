...
export const cancelDuration = new Trend('cancel_duration', true);
export const cancelSuccess = new Rate('cancel_success');
export const paymentDuration = new Trend('payment_duration', true);
export const paymentSuccess = new Rate('payment_success');
export const actionErrors = new Counter('action_errors');
export const outcomeMismatches = new Counter('outcome_mismatches');
export const unresolvedOutcomes = new Counter('unresolved_outcomes');
export const purchasedOutcomes = new Counter('purchased_outcomes');
export const cancelledOutcomes = new Counter('cancelled_outcomes');
export const checkoutExpiredOutcomes = new Counter('checkout_expired_outcomes');
export const queueRejectedOutcomes = new Counter('queue_rejected_outcomes');
export const soldOutOutcomes = new Counter('sold_out_outcomes');
